...
oTree.prototype.setTextEvent = function(param, obj, callback){
	if(callback != null){
		...
		callback(param.param != null ? param.param : this.getTextParam(obj), this.callbackObj);
	} else {
		...
		if(obj != null && !obj.disabled){
			obj.onclick = function(){
				...
				if(param.callback != null){
					param.callback(param.param != null ? param.param : {chbName:param.name, id:param.id, value:this.value}, _.callbackObj);
				}
			};
		}
	}
