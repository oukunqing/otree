...
oTree.prototype.findTargetNode = function(node, key, oldNode){
	//alert('keyDownTimes:' + this.keyDownTimes);
	if(38 == key){
		...
		//alert('nid:' + node.lang + ',' + nData.hasChild + ',' + nData.isExpand);
		...
		var nData = this._getNodeData(node.lang);
		//alert('node:' + node.lang + ',hasChild:' + nData.hasChild + ',isExpand:' + nData.isExpand);
